...
return [
    ...
    */
    ...
    'nav.log.label' => 'Activiteitenlogboek',
    'nav.log.icon' => 'heroicon-o-clipboard-document-list',
    'resource.label.log' => 'Activiteitenlogboek',
    'resource.label.logs' => 'Activiteitenlogboeken',
    ...
    'resource.label.logged_at' => 'Vastgelegd op',
