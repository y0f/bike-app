...
>**NOTE:** This project was created for learning purposes and is not production-ready. I initially started it to explore Filament, but while building a SaaS at my job using Filament, I lost interest in continuing this personal project. With that being said, there are still useful components and ideas in here, and contributions are welcome if you’d like to build on it or improve what’s already been done.
